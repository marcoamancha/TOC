...
export const SideBar = () => {
  return (
    ...
    <aside className="relative bg-azul h-screen w-64 hidden sm:block shadow-xl">
    <div className="p-6">
        ...
        <button className="w-full bg-white cta-btn font-semibold py-2 mt-5 rounded-br-lg rounded-bl-lg rounded-tr-lg shadow-lg hover:shadow-xl hover:bg-gray-300 flex items-center justify-center">
            <i className="fas fa-plus mr-3"></i> Nueva Cita
        </button>
    </div>
    ...
    <a href="#1" className="absolute w-full upgrade-btn bottom-0 active-nav-link text-white flex items-center justify-center py-4">
