  ...
  return (
    <div className="bg-tomate">
        ...
        <div className="my-2 text-center justify-center md:my-8">
            <a href="#1" className="inline-block text-sm px-4 py-2 mr-2 leading-none border rounded bg-white text-tomate font-bold mt-4 lg:mt-0 transform transition hover:scale-105 duration-300 ease-in-out">Reservar</a>
        </div>
