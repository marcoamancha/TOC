  ...
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 pt-20">
      <div className="flex justify-center items-center flex-col aspect-w-16 aspect-h-9">
        ...
        <h2 className="text-azul  text-xl md:text-4xl font-bold">Tocamos <small className="text-tomate text-xl md:text-4xl font-bold">tu vida</small></h2>
        <h2 className="text-azul  text-xl my-4 md:text-4xl font-bold">Centro de bienestar humano</h2>       
